		...
		InvalidKeyException, SignatureException, IOException, NoSuchAlgorithmException, InvalidKeySpecException {
			...
			while(escolha != 0) {
				...
				case 1:
					...
					System.out.println("Digite o nome do documento e extensão[Exemplo na Raiz do Projeto (texto.txt)]: ");
				...
				case 2:
					in = new Scanner(System.in);
					System.out.println("Digite o nome do documento e extensão[Arquivo deve estar presente na raiz do Projeto]: ");
